...
const baseLibsUrl = path.resolve(
  ...
  plugins: [
    ...
    */
    ...
    new CopyWebpackPlugin([
      ...
      {
        from: path.resolve(__dirname, '../src/libs/blockly/blockly_compressed.js'),
        to: baseLibsUrl
      },
      {
        from: path.resolve(__dirname, '../src/libs/blockly/blocks_compressed.js'),
        to: baseLibsUrl
      },
      {
        from: path.resolve(__dirname, '../src/libs/blockly/javascript_compressed.js'),
        to: baseLibsUrl
      },
      {
        from: path.resolve(__dirname, '../src/libs/blockly/python_compressed.js'),
        to: baseLibsUrl
      }
    ])
  ]
